// g++ extended.cpp ../filters/kalman_filter.cpp ../models/aem_model_raw.cpp ../converters/aem_converter.cpp ../fft23.cpp ../text_utils.cpp ../math_utils.cpp -o extended
...
int main()
{
   ...
   std::ofstream output("result_ext.XYZ");
   ...
   kalman_filter k = kalman_filter(&conv);
   ...
   kalman_filter k_s = kalman_filter(&simple_conv);
   ...
   while(getline(data_file, buf))
   {
      ...
      for(it = 0; it < 10; it++)
      {
         ...
         k_s.get_update_vector(upd_vec, resp_reduced);      
         k_s.m->update(upd_vec, resp_reduced, res, k_s.R);
      ...
      for(it=0; it<10; it++)
      {
         ...
         k.get_update_vector(upd_vec, resp);      
         k.m->update(upd_vec, resp, res, k.R);
