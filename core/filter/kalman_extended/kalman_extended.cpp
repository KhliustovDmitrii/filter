...
namespace filter
{
void Kalman_Extended::get_update(std::vector<double> &mes, std::vector<double> &upd_vec, std::vector<double> &upd_cov) const
{
    int i;
...
void Kalman_Extended::get_jacobian() const
{
    int i, j;
    double h = 0.001;
    double param;
...
void Kalman_Extended::proc(int k, std::vector<double> &upd_vec, std::vector<double> &upd_cov, double delta) const
{
    int i,j;
